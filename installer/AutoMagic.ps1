...
Remove-Item "C:\Users\*\Desktop\Google Cloud SDK Shell.*"; 
...
choco install google-drive-file-stream; $wshell = New-Object -ComObject wscript.shell; $wshell.SendKeys('~'); Remove-Item "C:\Users\kiyoe\Desktop\Google Docs.*", "C:\Users\kiyoe\Desktop\Google Sheets.*", "C:\Users\kiyoe\Desktop\Google Slides.*"; $wshell.AppActivate('Sign in to Google Drive'); Sleep 1; $wshell.SendKeys('~');
...
Invoke-WebRequest -Uri 'https://github.com/mifi/lossless-cut/releases/download/v3.37.0/LosslessCut-win.exe' -OutFile 'C:\Users\kiyoe\Desktop\LosslessCut.exe'; 
